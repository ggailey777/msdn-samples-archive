...
(function () {
    ...
    app.onactivated = function (args) {
        if (args.detail.kind === activation.ActivationKind.launch) {
            ...
            ////TODO: Uncomment the following lines of code that prevents caching of the responses 
            //// to GET requests when the 'Refresh' button is clicked; the supplied header 
            //// prevents caching.
            ...
            var insertTodoItem = function (todoItem) {
                ...
                // TODO: Delete or comment-out the following if-else statement; Mobile Services auto-generates the ID value.                 
